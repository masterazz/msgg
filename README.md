...
Clone the repository:git clone https://github.com/masterazz/msgg.git
...
Example for Google AdSense in head.inc:<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1234567890123456" crossorigin="anonymous"></script>
